...
##' @param demography A vector of populations (absolute or relative) of the age groups given in \code{immunity}; if it is not given, it will be assumed that the mixing matrix is already normalised
